README for Supplementary Material - Emotion Annotation and Fleiss' Kappa App

Description:
This supplementary material provides the source code for a Streamlit web application designed for audio emotion annotation and inter-rater agreement analysis using Fleiss' Kappa. The application allows users to:
...
Detailed Information about Interacting with the Objects:
